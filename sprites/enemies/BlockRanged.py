...
class BlockRanged(Enemy):
    def __init__(self, pos, experiance_group, projectile_group, enemy_group, particle_group, cam_offset): 
        ...
        super(BlockRanged, self).__init__(pos, (animation_move, animation_hurt), (32*SCALE_FACOTOR, 32*SCALE_FACOTOR), experiance_group, projectile_group, enemy_group, particle_group, cam_offset)
    ...
    # move method override updates the target velocity
    ...
    def boundary_collision(self, boundary, x_bound, y_bound):
        hit = super().boundary_collision(boundary, x_bound, y_bound)
